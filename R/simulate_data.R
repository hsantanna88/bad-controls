...
#' relationship, giving true \eqn{\mathrm{ATT}(g,t) = \beta_t \lambda_e + \delta_e}.
#'
#' The true \eqn{\mathrm{ATT}(g,t)} only ever depends on \eqn{\beta_t} at the
...
#' groups = 2} already gives true \eqn{\mathrm{ATT} = \delta+\lambda = 1.00}. But

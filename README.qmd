...
<!-- badges: start -->
[![Version](https://img.shields.io/badge/version-`r packageVersion("badcontrols")`-blue.svg)](https://github.com/hsantanna88/bad-controls)
...
cat("True ATT:", sim$true_att_overall, "\n")
